...
// https://codepen.io/yudizsolutions/pen/wvZEeNE
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // hide desc image and unhide other images on expand - opposite on unexpand
$('.card-main').click(function() {
    if ($(this).hasClass('expanded')){
      $(this).removeClass('expanded');
      $(this).find('.algo-desc-img').show();
      $(this).find('.algo-desc-img-hidden').hide();
      $(this).find('.expanded-text').hide();
      $(this).find('.surface-text').show();
    }
    else{
      $(this).addClass('expanded');
      $(this).find('.surface-text').hide();
      $(this).find('.algo-desc-img').hide();
      $(this).find('.algo-desc-img-hidden').show();
      $(this).find('.expanded-text').show();
    }
});
